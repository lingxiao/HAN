...
# Given valid file path `inFile` and output file names
# `outX` for the set of regressors and `outy` for set of regressands,
# read and clean yelp jsn according to subroutine `yelp`.
...
# Logic specific to yelp json with [text] and [stars] fields
...
# @Use: iterate over a file and pull out the `X` to be saved as `outName1`
#       and the `b` 
